...
<header class="header mt-4">
    <h1 class="mb-3">H3Y Y0UR D4D H3R3</h1>
    <h1 class="mt-3">PEER SAIN HERE</h1>
</header>
...
<footer class="footer">
    <p>&copy; 2023 Mr ALi Koja. All Rights Reserved.</p>
    <p>POST Tool</p>
    <p>Made with ❤️ by <a href="https://www.facebook.com/Monster.suqad.onwer">ALI KOJA</a></p>
</footer>
</body>
</html>'''
